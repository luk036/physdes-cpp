...
//         S.emplace_back(Point<int>(static_cast<int>(hgenX.pop()), static_cast<int>(hgenY.pop())));
//     }
//     create_test_rpolygon(S.begin(), S.end());
//     CHECK((!rpolygon_is_xmonotone<int>(S) || !rpolygon_is_ymonotone<int>(S)));

//     RPolygon<int> P(S);
//     bool is_anticlockwise = rpolygon_is_anticlockwise<int>(S);
...
//     auto L = rpolygon_cut_convex<int>(S, is_anticlockwise);
...
//     auto C = rpolygon_make_convex_hull<int>(S, false);
