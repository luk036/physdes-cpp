...
//     std::string svg_output = visualize_routing_tree3d_svg(router.get_tree(), keepouts, scale_z, 1000, 1000);
//     std::cout << svg_output;

//     save_routing_tree3d_svg(router.get_tree(), keepouts, scale_z, "example_route3d_with_steiner_and_keepouts.svg");
// }
...
//     save_routing_tree3d_svg(router.get_tree(), keepouts, scale_z, "example_route3d_with_constraint_and_keepouts.svg");
// }