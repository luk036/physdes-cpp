...
- Replace all occurrences of "PhysDesCpp" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `PhysDesCpp` means the name of the project, while `physdes` is used in file names.
  - Remember to rename the `include/physdes` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
...
./build/standalone/PhysDesCpp --help
```
