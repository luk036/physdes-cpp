...
auto GlobalRoutingTree::get_tree_structure(const RoutingNode* node, int level) const -> std::string {
...
std::string visualize_routing_tree_svg(const GlobalRoutingTree& tree, int width, int height, int margin) {
...
void save_routing_tree_svg(const GlobalRoutingTree& tree, std::string filename, int width, int height) {
